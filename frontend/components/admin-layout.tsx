...
import { LayoutDashboard, Users, BookOpen, Bell, Settings, LogOut, Menu, X, FileText } from "lucide-react"
...
export default function AdminLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: "Materials", href: "/dashboard/admin/materials", icon: FileText },
