...
import { LayoutDashboard, BookOpen, Bell, ClipboardList, FileText, Settings, LogOut, Menu, X } from "lucide-react"
...
export default function StudentLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: "Materials", href: "/dashboard/student/materials", icon: FileText },
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-muted-foreground">alice.brown@college.edu</p>
                </div>
              </div>
